...
DATABASES = {
    'default': {
        ...
        # --- Performance: keep connections alive instead of reconnecting each request ---
        'CONN_MAX_AGE': 60,          # reuse connection for 60s
        'CONN_HEALTH_CHECKS': True,  # verify stale connections before reuse
        'OPTIONS': {
            'keepalives': 1,
            'keepalives_idle': 30,
